...
class Test_Login:
    ...
    def test_addcustomer_005(self, setup):
        ...
        self.driver.find_element(By.XPATH,
                                 "//body/div[@id='layoutDrawer']/div[@id='layoutDrawer_content']/main/div[@class='container-xl p-4']/form[@class='row']/div[@class='row gx-3']/div[@class='col-lg-8']/div[@class='card card-raised mb-5']/div[@class='card-body p-5']/div[1]").click

        # Country = Select(self.driver.find_element(By.XPATH, "//select[@class ='chosen-select select2-offscreen']"))
        # Country.select_by_index(2)
        time.sleep(1)
        # self.ac.DropDown_Country(4)
